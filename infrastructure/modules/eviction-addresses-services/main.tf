  ...
  template {
    containers {
      ...
      volume_mounts {
        ...
        mount_path = "/workspace/eviction-addresses-service-account.json"
        sub_path   = "eviction-addresses-service-account.json"
      }
      
      # Config file - mounted as volume
      volume_mounts {
        name       = "config"
        mount_path = "/workspace/config.yml"
        sub_path   = "config.yml"
      }
    ...
    volumes {
      name = "ssl-certs"
      secret {
        secret       = google_secret_manager_secret.ssl_certs.secret_id
        default_mode = 0400
        items {
          version = "latest"
  ...
  template {
    containers {
      ...
      volume_mounts {
        ...
        mount_path = "/workspace/eviction-addresses-dashboard-service-account.json"
        sub_path   = "eviction-addresses-dashboard-service-account.json"
      }
      ...
      volume_mounts {
        name       = "client-id"
        mount_path = "/workspace/client-id.json"
        sub_path   = "client-id.json"
      }
      
      # Environment variables
      volume_mounts {
        name       = "renviron"
        mount_path = "/workspace/.Renviron"
        sub_path   = ".Renviron"
      }

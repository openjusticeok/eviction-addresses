...
eviction_addresses_api_yaml <- cr_build_yaml(
  steps = c(
    ...
    cr_buildstep_run(
      ...
      image = "us-central1-docker.pkg.dev/ojo-database/docker/eviction-addresses-api-test:$BUILD_ID",
      port = 3838,
      memory = "2G",
      cpu = 1,
      max_instances = 1,
...
eviction_addresses_dashboard_yaml <- cr_build_yaml(
  steps = c(
    ...
    cr_buildstep_run(
      ...
      image = "us-central1-docker.pkg.dev/ojo-database/docker/eviction-addresses-dashboard-test:$BUILD_ID",
      port = 3838,
      memory = "1G",
      cpu = 1,
      max_instances = 1,
